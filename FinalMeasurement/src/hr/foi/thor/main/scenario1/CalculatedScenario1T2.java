...
public class CalculatedScenario1T2 {
	...
	public void run(){
		 System.out.println(" --- FM-S ---");
			...
			long c6s = System.nanoTime();
				i.runSg(i.createBufferedImage("/home/ivan/dev/imgs/testimages/320.jpg"));
			long c6e = System.nanoTime();
			
			
	        System.out.println(" --- FM-D-S ---");
		        System.out.println("cpu-s-640: " + (float) ((c1e-c1s)/1e6));
		        System.out.println("cpu-sge-640: " + (float) ((c2e-c2s)/1e6));
		        System.out.println("cpu-sge-1280: " + (float) ((c3e-c3s)/1e6));
		        System.out.println("cpu-sgedh-1280: " + (float) ((g1e-g1s)/1e6));
		        ...
		        System.out.println("cpu-s-320: " + (float) ((c4e-c4s)/1e6));
		        System.out.println("cpu-g-320: " + (float) ((c5e-c5s)/1e6));
		        System.out.println("cpu-sg-320: " + (float) ((c6e-c6s)/1e6));
